...
const Resume = () => {
    ...
    const handleDownload = () => {
        ...
        const resumeUrl = 'public\THIRUMALA BHARGAV VALLAMKONDA_RESUME.pdf';

        // Create a temporary anchor element
        const link = document.createElement('a');
        link.href = resumeUrl;
        link.download = 'public\THIRUMALA BHARGAV VALLAMKONDA_RESUME.pdf'; // Specify the file name users will see when downloading
